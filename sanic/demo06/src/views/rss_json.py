...
BluePrint
'''
json_bp = Blueprint('rss_json',url_prefix='json') # name,prefix
json_bp.static(
    '/statics/rss_json',
    os.path.join(CONFIG.BASE_DIR,'/statics/rss_json')
)
...
env = Environment(
    loader=PackageLoader('views.rss_json', '../templates/rss_json'), ## 这个路径怎么回事??
